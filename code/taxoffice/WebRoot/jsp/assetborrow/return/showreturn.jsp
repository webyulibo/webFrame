...
<body>
	<div class="container-f">
		<div class="box-title clearfix tab-title">
			<h3>
				<a href="<%=basePath%>jsp/assetborrow/borrow/addborrow.jsp"> <span
					class="fa fa-table"></span> 资产借用
				</a>
			</h3>
			<h3 class="current">
				<a href="<%=basePath%>jsp/assetborrow/return/addreturn.jsp"> <span
		...
		<div style="margin-top:20px;margin-left:10px;">
			<a class="btn btn-primary"
				href="<%=basePath%>jsp/assetborrow/return/addreturn.jsp">返回</a>
		</div>
		<fieldset class="search" style="margin-top:20px;">
			...
			<div class="show tab-lbgl">
				<table class="table-hover dataTable">
					...
					<tr>
						...
						<td>1200020030000</td>
						<td>办公室</td>
						<td><a href="javascript:void(0)" class="btn" rel="tooltip"
							title="查看" id="btncheck"> <i class="fa fa-search"></i>查看
						</a></td>
					</tr>
				</table>
			</div>
			...
			<div class="font">
				<cc:page value="${pager}"
					url="${basePath}adminasset/showassetmenu.htm?category=${category }&text=${text }&usestate=${usestate }&state=${state }"></cc:page>
			</div>
