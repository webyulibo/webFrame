...
<body>
	...
	<div class="lbgl-top-left f_1" style="margin-top:60px;margin-left:100px;">
			<a href="<%=basePath %>jsp/assetborrow/borrow/showborrow.jsp" class="btn btn-add" style="width:110px;">
			<i class="fa fa-plus"></i><span>查看借用记录列表</span>
			</a>
		</div>
		...
		<div>
			<table class="tab">
				...
				<tr>
					...
					<td>
						<input type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" 
						placeholder="拟还日期" class="laydate-icon" id="demo2" value=" 2016-06-15 " 
						name="purchasetime" style="text-align:center;height:25px;">
					</td>
					<td>借用部门：</td>
					<td>
				...
				<tr>
					...
					<td colspan="3">
						<textarea rows="4" style="width:550px" value="" name="remark"></textarea>
					</td>
				</tr>
			</table>
