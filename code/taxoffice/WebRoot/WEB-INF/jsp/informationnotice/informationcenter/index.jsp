		...
		<div>
			<table class="tab">
				...
				<tr>
					...
					<td width="250px">
						<select class="easyui-combobox" name="acceptdep" id="acceptdep" style="width:150px;height:30px;border:solid 1px gray;padding-left:7px;">
						</select>
					</td>
					<td></td>
					<td></td>
				...
				<tr>
					...
					<td colspan="3">
						<textarea rows="4" style="width:550px" value="" id="detailresult" name="detailresult"></textarea>
					</td>
				</tr>
			</table>
