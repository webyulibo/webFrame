  ...
  <body>
	...
	<div class="container-f">
		<div class="box-title clearfix tab-title">
			<h3 class="current">
				<a
					href="<%=basePath%>adminasset/showassetmenu.htm">
					<span class="fa fa-table"></span> 资产管理
				</a>
			</h3>
			<h3>
				<a href="<%=basePath %>adminasset/showassetinput.htm">
					<span class="fa fa-cog"></span> 资产信息导入
				</a>
			</h3>
			<h3>
				<a href="<%=basePath %>adminasset/showassetoutput.htm">
					<span class="fa fa-bar-chart-o"></span> 资产信息导出
				</a>
			</h3>
		</div> 
		<div class="box-content clearfix">
			<div class="row clearfix">
				<div class="control-group f_l">
					<div class="f_l">
						<a style="margin-top:10px;margin-bottom:20px;margin-left:8px;" id="btn-add" class="btn cf" href="<%=basePath%>adminasset/showassetadd.htm" >
							<i class="fa fa-plus"></i>添加
						</a>
					</div>
				</div>
			</div>	
		<form action="<%=basePath %>adminasset/getassetcheckresultwithpage.htm" class="form-horizontal ajax_form"  method="post"  id="editform">
...
<!-- 										 <option value=""></option>
				...
				<!-- </form> -->
					<td colspan="2">
						<div class="control-group f_l">
								<a style="margin-top:10px;margin-right:100px;float:right;" onclick="subForm()" class="btn cf"  href="javascript:void(0)"> 
