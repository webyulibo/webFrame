 ...
 * Generated at: 2017-06-13 04:28:25 UTC
...
public final class content_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\tif(categoryId==\"61\"){//logo及地址的id对应hiddentype\r\n");
      ...
      out.write("\t\t\t\tvar option3=datagrid.datagrid('getColumnOption', 'titleDesc');\r\n");
      out.write("\t\t\t\toption1.title = \"电话\";\r\n");
      out.write("\t\t\t\toption2.title = \"传真\";\r\n");
      out.write("\t\t\t\toption3.title = \"地址\";\r\n");
      out.write("\t\t\t\tdatagrid.datagrid();//更新标题文本为电话传真地址\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('hideColumn', 'url');//隐藏对应的列\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('hideColumn', 'pic2');\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('showColumn', 'pic');\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('showColumn', 'title');//显示对应的列\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('showColumn', 'subTitle');\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('showColumn', 'titleDesc');\r\n");
      out.write("\r\n");
      out.write("\t\t\t}else if(categoryId==\"62\"||categoryId==\"65\"||categoryId==\"68\"){//相关链接、院长信箱、推荐站点\r\n");
      out.write("\t\t\t\tvar option1=datagrid.datagrid('getColumnOption', 'title');\r\n");
      out.write("\t\t\t\tvar option2=datagrid.datagrid('getColumnOption', 'url');\r\n");
      out.write("\t\t\t\toption1.title = \"链接名称\";\r\n");
      out.write("\t\t\t\toption2.title = \"链接地址\";\r\n");
      out.write("\t\t\t\tdatagrid.datagrid();//更新标题文本为电话传真地址\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('hideColumn', 'subTitle');//隐藏对应的列\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('hideColumn', 'titleDesc');\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('hideColumn', 'pic');\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('hideColumn', 'pic2');\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('showColumn', 'title');//显示对应的列\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('showColumn', 'url');\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t}else if(categoryId==\"63\"){//关注我们\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('hideColumn', 'subTitle');//隐藏对应的列\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('hideColumn', 'titleDesc');\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('hideColumn', 'title');\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('hideColumn', 'url');\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('showColumn', 'pic');//显示对应的列\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('showColumn', 'pic2');\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t}else if(categoryId==\"69\"){ //页眉logo\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('hideColumn', 'subTitle');//隐藏对应的列\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('hideColumn', 'titleDesc');\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('hideColumn', 'title');\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('hideColumn', 'url');\r\n");
      ...
      out.write("\t\t\t\tdatagrid.datagrid('showColumn', 'pic');//显示对应的列\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t}else if(categoryId==\"64\"){//大广告\r\n");
      out.write("\t\t\t\tvar option1=datagrid.datagrid('getColumnOption', 'title');\r\n");
      out.write("\t\t\t\toption1.title = \"内容标题\";\r\n");
      out.write("\t\t\t\tdatagrid.datagrid();//更新标题文本为电话传真地址\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('hideColumn', 'subTitle');//隐藏对应的列\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('hideColumn', 'titleDesc');\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('hideColumn', 'url');\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('hideColumn', 'pic2');\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('showColumn', 'pic');//显示对应的列\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('showColumn', 'title');\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t}else {//在线展示\r\n");
      out.write("\t\t\t\tvar option1=datagrid.datagrid('getColumnOption', 'title');\r\n");
      out.write("\t\t\t\tvar option2=datagrid.datagrid('getColumnOption', 'subTitle');\r\n");
      ...
      out.write("\t\t\t\toption3.title = \"内容描述\";\r\n");
      out.write("\t\t\t\tdatagrid.datagrid();//更新标题文本为电话传真地址\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('hideColumn', 'subTitle');//隐藏对应的列\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('hideColumn', 'titleDesc');\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('showColumn', 'url');//显示对应的列\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('showColumn', 'pic2');\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('showColumn', 'pic');\r\n");
      out.write("\t\t\t\tdatagrid.datagrid('showColumn', 'title');\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\tif(categoryId==\"61\"){//logo及地址的id对应hiddentype\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\thiddentype=0;//电话传真地址\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t}else if(categoryId==\"62\"||categoryId==\"65\"||categoryId==\"68\"){//相关链接、院长信箱、推荐站点\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\thiddentype=1;//只是 链接名称以及地址\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t}else if(categoryId==\"63\"){//关注我们\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\thiddentype=2;//单单两个图片\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t}else if(categoryId==\"69\"){ //页眉logo\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\thiddentype=2;//只显示一个图片\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t}else if(categoryId==\"64\"){//大广告\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\thiddentype=4;//显示一个标题和显示一个图片\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t}else {//在线展示\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\thiddentype=5;//显示标题、url、以及内容\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tif(hiddentype==\"0\"){//对应的左下角logo以及地址\r\n");
      out.write("\t\t\t$(\"#J_title1\").html(\"电话\");\r\n");
      out.write("\t\t\t$(\"#J_subTitle1\").html(\"传真\");\r\n");
      out.write("\t\t\t$(\"#J_titleDesc1\").html(\"地址\");\r\n");
      ...
      out.write("\t\t\t document.getElementById(\"J_specialy\").style.display=\"none\";\r\n");
      out.write("\t\t\t document.getElementById(\"J_titleDesc1y\").style.display=\"none\";\r\n");
      out.write("\t\t}else if(hiddentype==\"1\"){//相关链接  只是 链接名称以及地址\r\n");
      out.write("\t\t\t$(\"#J_title1\").html(\"链接名称\");\r\n");
      out.write("\t\t\t$(\"#J_url1\").html(\"链接地址\");\r\n");
      ...
      out.write("\t\t\t document.getElementById(\"J_specialy\").style.display=\"none\";\r\n");
      out.write("\t\t\t document.getElementById(\"J_titleDesc1y\").style.display=\"none\";\r\n");
      out.write("\t\t}else if(hiddentype==\"5\"){//公告、新闻等\r\n");
      out.write("\t\t\t document.getElementById(\"J_titleDesc1\").style.display=\"none\";\r\n");
      out.write("\t\t\t document.getElementById(\"J_titleDesc2\").style.display=\"none\";\r\n");
      out.write("\t\t\t document.getElementById(\"J_subTitle1\").style.display=\"none\";\r\n");
      out.write("\t\t\t document.getElementById(\"J_subTitle2\").style.display=\"none\";\r\n");
