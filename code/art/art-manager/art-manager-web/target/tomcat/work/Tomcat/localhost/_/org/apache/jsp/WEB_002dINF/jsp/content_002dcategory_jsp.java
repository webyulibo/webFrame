 ...
 * Generated at: 2017-06-13 04:28:24 UTC
...
public final class content_002dcategory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\tvar pnode=tree.tree(\"getParent\",node.target);\r\n");
      ...
      out.write("\t\tif(tree.tree(\"isLeaf\",node.target)==false){\r\n");
      out.write("\t\t\t$.messager.alert('提示',\"该类别下存在子分类，请先将子分类删除后再删除该分类！\");\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\t$.messager.confirm('确认','确定删除名为 '+node.text+' 的分类吗？',function(r){\r\n");
      out.write("\t\t\t\tif(r){\r\n");
      out.write("\t\t\t\t\t$.post(\"/content/category/delete/\",{parentId:pnode.id,id:node.id},function(){\r\n");
